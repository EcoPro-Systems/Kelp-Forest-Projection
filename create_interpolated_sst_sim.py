...
#sim_sst = xr.open_dataset("Data/tos_Omon_GFDL-ESM4_ssp126_r1i1p1f1_gr_19000101-21001231.downscaled_std.gridded.nc")

sim_data = xr.open_dataset("Data/tos_Omon_GFDL-ESM4_ssp126_r1i1p1f1_gr_2002-2100.downscaled_std.unique.nc", decode_times=False)
#sim_data = xr.open_dataset("Data/tos_Omon_GFDL-ESM4_ssp585_r1i1p1f1_gr_2002-2100.downscaled_std.unique.nc", decode_times=False)
...
# save data
with open(f'Data/kelp_interpolated_data_sim.pkl', 'wb') as f:
    pickle.dump(data, f)
...
ax.legend()
plt.tight_layout()
plt.savefig('Data/kelp_timeseries_sim.png', dpi=300)
plt.show()
plt.close()