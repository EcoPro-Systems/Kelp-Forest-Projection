...
if __name__ == "__main__":
    ...
    mlp = MLPRegressor(hidden_layer_sizes=(10,10,10), activation='relu', solver='adam', max_iter=250, verbose=True, alpha=0.0001, learning_rate='adaptive')
    ...
    print(f"Saved figure to {args.file_path.replace('.pkl', '_regressors.png')}")
    plt.close()
